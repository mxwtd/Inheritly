    ...
    <>
            ...
            <div className="flex items-center">
              <div className="flex items-center ml-3">
                <div className="flex items-center space-x-2">
                  <div className="border-r-[1.5px] border-gray-500 dark:border-gray-400 pr-3">
                    <button className="hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg mt-0.5 p-2">
                      <svg className="w-6 h-6 stroke-gray-700 dark:stroke-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <div className="pl-1">
                    <button id="theme-toggle" type="button" className="text-gray-800 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-sm p-2">
      ...
      <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <h2 className="text-gray-900 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700 py-4 mb-3">Dashboard</h2>
            ...
            <h2 className="text-gray-900 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700 py-4 mb-3 mt-3">Account</h2>
            <ul className="space-y-2 font-medium">
              <li>
                  <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <svg aria-hidden="true" className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
