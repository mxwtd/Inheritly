    ...
    <>
      <div className="p-4 sm:ml-64 h-screen">
        <div className="p-4 mt-14">
          ...
          <button id="defaultModalButton" onClick={() => setIsModalOpen(true)} className="block text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button">
            Add an Investment
          </button>
          </div>
          {/* Main modal */}
          <div id="defaultModal" className={`z-50 flex items-center justify-center w-full h-full ${isModalOpen ? '' : 'hidden'}`}>
            <div className="relative p-4 w-full max-w-2xl md:h-auto bg-white rounded-lg shadow dark:bg-slate-800 sm:p-5">
                  {/* Modal content */}
                          ...
                          <div className="grid gap-4 mb-4 sm:grid-cols-2">
                              ...
                              <div>
                                  ...
                                  <select id="category" className="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-slate-700 dark:border-slate-600 dark:placeholder-slate-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                      ...
                                      <option value="Jewelery" id="Jewelery">Vehicles</option>
