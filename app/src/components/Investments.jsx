      ...
      <div className='p-4 sm:ml-64 h-[100%]'>
        <div className='p-4 mt-14'>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-3 gap-4 mb-4 px-4'>
            <div className='flex items-center justify-center rounded-xl bg-gradient-to-b from-slate-300 to-blue-300 dark:bg-gradient-to-b dark:from-slate-800 dark:to-blue-300/20 h-48 md:hover:scale-102 transition-all cursor-pointer'>
            ...
            <Link to='/properties' className='flex items-center justify-center rounded-xl bg-gradient-to-b from-slate-300 to-blue-300 dark:bg-gradient-to-b dark:from-slate-800 dark:to-blue-300/20 h-48 md:hover:scale-102 transition-all cursor-pointer'>
            ...
            <Link to='/jewelery' className='flex items-center justify-center rounded-xl bg-gradient-to-b from-slate-300 to-blue-300 dark:bg-gradient-to-b dark:from-slate-800 dark:to-blue-300/20 h-48 md:hover:scale-102 transition-all cursor-pointer'>
