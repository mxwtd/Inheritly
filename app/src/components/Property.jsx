        ...
        <div className='z-5 relative flex flex-col rounded-xl bg-white dark:bg-slate-800 bg-clip-border shadow-3xl shadow-shadow-500 w-full p-4'>
          <div className='h-full w-full'>
            ...
            <div className='flex items-center justify-between md:items-center lg:justify-between '>
              ...
              <button className='text-slate-600 hover:text-slate-100 bg-slate-400/[.3] hover:bg-blue-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-slate-500 dark:hover:bg-slate-700 dark:text-slate-300 dark:hover:text-slate-100 transition duration-200'>View</button>
            </div>
          </div>
        </div>
      </div>
