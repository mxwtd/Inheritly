...
const NewVehicleForm = () => {
  ...
  const canSave = [name, brand, currency, date, value, taxStatus, brand, model, year].every(Boolean) && !isLoading
      ...
      <div className='bg-white backdrop-blur-md rounded-3xl shadow-xl dark:border md:mt-0 p-6 dark:bg-slate-800 dark:border-slate-700'>
        ...
        <form encType='multipart/form-data' onSubmit={onSaveVehicleClicked} className='space-y-4 md:space-y-6' action='#'>
          ...
          <div className='md:flex md:justify-between'>
            <div className='md:w-1/2 md:pr-2'>
              <div className='mb-2'>
                <label htmlFor='year' className='block mb-2 text-sm font-medium text-slate-700 dark:text-white'>Year</label>
                <input
                  type='year'
                  value={year}
                  name='year'
              ...
              <div>
                <label htmlFor='model' className='block mb-2 text-sm font-medium text-slate-700 dark:text-white'>Model</label>
                <input
                  type='model'
                  value={model}
                  name='model'
            ...
            <div className='md:w-1/2 md:pl-2'>
              <div>
                <label htmlFor='brand' className='block mb-2 text-sm font-medium text-slate-700 dark:text-white'>Brand</label>
                <input
                  type='text'
                  value={brand}
                  name='brand'
