...
import { useDeleteStockMutation, useGetStockByIdQuery } from '../services/stocksApiSlice'
        ...
        <div className='bg-white dark:bg-slate-600 rounded-xl md:w-[60%] xl:w-[45%] px-8'>
          <div className='flex flex-col items-center'>
            <div className='my-8 text-center'>
              ...
              <h2 className='text-2xl font-bold text-slate-800 dark:text-white mt-3'>{stock?.name}?</h2>
            </div>
